...
* Hotfix 20169-01: For openLuup, fix an error in a background non-critical task that cleans unused state variables from ReactorSensors (e.g. exported expressions that have been deleted).
